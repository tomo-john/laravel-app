                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-green-200 border border-gray-300 cursor-default leading-5 dark:bg-green-200 dark:border-gray-600 dark:text-gray-300">{{ $page }}</span>
                                    </span>
                                @else
